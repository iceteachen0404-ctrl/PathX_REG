...
class Prism(PreTrainedModel):
    ...
    def forward(
        ...
        text_proj = self.text_to_latents(decoder_out['text_embedding'])  # (batch_size, text_latent_dimension)
        image_proj = self.img_to_latents(resampler_out['image_embedding'])  # (batch_size, image_latent_dimension)
